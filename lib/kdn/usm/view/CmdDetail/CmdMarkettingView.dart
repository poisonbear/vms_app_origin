...
class CmdMarkettingview extends StatefulWidget {
  const CmdMarkettingview({super.key});

  @override
  State<CmdMarkettingview> createState() => _CmdViewState();
}

class _CmdViewState extends State<CmdMarkettingview> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<CmdMarkettingViewModel>( // 데이터를 불러 올 때는 Consumer 항상 viewmodel을 거쳐서 가져오기
                        ...
                        child: Row(
                            children: [
                              ...
                              Padding(
                                  ...
                                  child : TextWidgetString('선택',getTextcenter(),getSize10(),getText700(),getColorgray_Type6(),)
                              ),]
                        )
                    ),
