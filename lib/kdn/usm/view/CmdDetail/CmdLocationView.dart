...
class CmdLocationView extends StatefulWidget {
  const CmdLocationView({super.key});

  @override
  State<CmdLocationView> createState() => _CmdViewState();
}

class _CmdViewState extends State<CmdLocationView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CmdLocationViewModel>( // 데이터를 불러 올 때는 Consumer 항상 viewmodel을 거쳐서 가져오기
